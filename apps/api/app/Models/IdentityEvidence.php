...
class IdentityEvidence extends Model
{
    ...
    protected function casts(): array { return ['scanned_at' => 'datetime', 'purge_after' => 'datetime', 'purged_at' => 'datetime']; }
    /** @return BelongsTo<IdentityVerification, $this> */
    public function verification(): BelongsTo { return $this->belongsTo(IdentityVerification::class, 'identity_verification_id'); }
}
