...
type Provider = { id: number; displayName: string; avatarUrl: string | null; services: Reference[]; serviceAreas: Reference[]; availabilityStatus: string; verified: boolean; rating: number | null; reviewCount: number; completedJobs: number };
