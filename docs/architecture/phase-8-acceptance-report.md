...
| Policy | ADR-0022 and the release runbook prohibit background location, self-update, and unreviewed store promotion. Full-screen intent and call-style alerts are authorized only for incoming/active hired-job calls (Decision 0034). |
